...
output_path = "watermap/src/main/resources/static/data/lake_okeechobee_test.json"
...
for i in range(100):
    ...
    entry = {
        ...
        "lat": round(random.uniform(26.6, 27.15), 5),
        "lon": round(random.uniform(-81.15, -80.55), 5)
    }
